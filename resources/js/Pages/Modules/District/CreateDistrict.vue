    ...
    <AdminLayout>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0">DISTRICT CREATE</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a :href="route('district.index')">District</a></li>
                            <li class="breadcrumb-item active">District Create</li>
                        </ol>
                    </div>
                </div>
            </div>
