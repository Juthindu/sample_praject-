...
async function handleSubmit() {
    ...
    store("own.sample.data.confirm", formData);
}
const testDetails = {
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a :href="route('release.own.sample.data.index')">
                            <li class="breadcrumb-item active">Sample Data Management</li></a>
                            </li>
                            <li class="breadcrumb-item active">NWSDB  WATER RESOURCE SAMPLE RESULT</li>
                        </ol>
                    </div>
                </div>
            </div>
