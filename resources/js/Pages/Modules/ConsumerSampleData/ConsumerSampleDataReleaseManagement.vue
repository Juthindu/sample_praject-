...
const consumer_sample_table_columns = [
    ...
    { field: 'weather_condition', title: 'Weather Condition' },
    // {
...
<template>
    <AdminLayout>
        <Head title="Sample-Data-Release-Management" />
        <!-- Dashboard Header -->
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h4 class="m-0">CONSUMER SAMPLE DATA RELEASE</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a :href="route('dashboard')">Dashboard</a></li>
                            <li class="breadcrumb-item active">Sample Data Release Management</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <!-- <a :href="route('consumer.sample.data.test.create')"><button class="btn btn-primary mr-2">Release All Completed Result</button></a> -->
                    </div>
                </div>
                <!-- DataTable Row -->
                <div class="row mt-4">
                        ...
                        <div class="card card-default">
                            <div class="card-body" style="padding: 0px;">
                                <DataTable
                                    ...
                                    fetch_url="/api/consumer-sample-data-release"
                                    ...
                                    edit_route_name= 'consumer.sample.data.release.show'
                                    use_delete_button=true 
                                    use_test_button=true 
