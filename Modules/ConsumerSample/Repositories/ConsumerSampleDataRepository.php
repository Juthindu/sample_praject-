...
class ConsumerSampleDataRepository implements ConsumerSampleDataRepositoryInterface{
    use ApiCrudTrait;

    protected $model;

    public function __construct(ConsumerSampleData $consumerSampleData)
    {
        $this->model = $consumerSampleData;
    }
